...
public partial class wgdb_000Context : DbContext
{
    ...
    public virtual DbSet<VIEW_CARD_BALANCE> VIEW_CARD_BALANCEs { get; set; }
    ...
    public virtual DbSet<alesis_view> alesis_views { get; set; }
    ...
    public virtual DbSet<c2_draw_audit_plays_v> c2_draw_audit_plays_vs { get; set; }
    ...
    public virtual DbSet<games_v> games_vs { get; set; }

    public virtual DbSet<games_v2> games_v2s { get; set; }
    ...
    public virtual DbSet<plays_v> plays_vs { get; set; }
    ...
    public virtual DbSet<sales_per_hour_v> sales_per_hour_vs { get; set; }

    public virtual DbSet<sales_per_hour_v2> sales_per_hour_v2s { get; set; }
    ...
    public virtual DbSet<terminals_last_changed> terminals_last_changeds { get; set; }

    public virtual DbSet<terminals_last_play_session> terminals_last_play_sessions { get; set; }
    ...
    public virtual DbSet<terminals_view> terminals_views { get; set; }
    ...
    public virtual DbSet<v_TotalEntrancesByVisit> v_TotalEntrancesByVisits { get; set; }

    public virtual DbSet<v_TotalEntriesByMonth> v_TotalEntriesByMonths { get; set; }

    public virtual DbSet<v_TotalVisitsByDay> v_TotalVisitsByDays { get; set; }

    public virtual DbSet<vw_money_collection_contadores_diario> vw_money_collection_contadores_diarios { get; set; }
